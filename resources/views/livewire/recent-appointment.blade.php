...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  <h5 class="text-2xl mb-2">Recent Appointment</h5>
    <!-- Card -->
                ...
                <tr class="bg-white hover:bg-gray-50">
                  ...
                  <td class="h-px w-72 min-w-72 align-top">
                    <a class="block p-6" href="#">
                      ...
                      <span class="block text-sm font-semibold text-gray-800">I just love it!</span>
                ...
                <tr class="bg-white hover:bg-gray-50">
                  ...
                  <td class="h-px w-72 min-w-72 align-top">
                    <a class="block p-6" href="#">
                      ...
                      <span class="block text-sm font-semibold text-gray-800">Really nice</span>
                  ...
                  <td class="h-px w-72 min-w-72 align-top">
                    <a class="block p-6" href="#">
                      <div class="flex gap-x-1 mb-2">
                        ...
                        <svg class="shrink-0 size-3 text-gray-400" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                          <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
                        </svg>
                      </div>
                      <span class="block text-sm font-semibold text-gray-800">Good product</span>
                ...
                <tr class="bg-white hover:bg-gray-50">
                  <td class="size-px whitespace-nowrap align-top">
                    <a class="block p-6" href="#">
                      <div class="flex items-center gap-x-4">
                        ...
                        <div>
                          <span class="block text-sm font-semibold text-gray-800">Levis women's jeans</span>
                        </div>
                      </div>
                    </a>
                  </td>
                  ...
                  <td class="h-px w-72 min-w-72 align-top">
                    <a class="block p-6" href="#">
                      ...
                      <span class="block text-sm font-semibold text-gray-800">Buy the product, you will not regret it!</span>
                ...
                <tr class="bg-white hover:bg-gray-50">
                  <td class="size-px whitespace-nowrap align-top">
                    <a class="block p-6" href="#">
                      <div class="flex items-center gap-x-4">
                        ...
                        <div>
                          <span class="block text-sm font-semibold text-gray-800">Asos T-shirts</span>
                        </div>
                      </div>
                    </a>
                  </td>
                  <td class="size-px whitespace-nowrap align-top">
                    <a class="block p-6" href="#">
                      <div class="flex items-center gap-x-3">
                        <span class="inline-flex items-center justify-center size-[38px] rounded-full bg-gray-300">
                          <span class="font-medium text-gray-800 leading-none">D</span>
                        </span>
                        <div class="grow">
                          <span class="block text-sm font-semibold text-gray-800">David Harrison</span>
                          <span class="block text-sm text-gray-500">david@site.com</span>
                  ...
                  <td class="h-px w-72 min-w-72 align-top">
                    <a class="block p-6" href="#">
                      ...
                      <span class="block text-sm font-semibold text-gray-800">Ready for the heat!</span>
                  ...
                  <td class="size-px whitespace-nowrap align-top">
                    <a class="block p-6" href="#">
                      <span class="text-sm text-gray-600">07 May 2022</span>
                    </a>
                  </td>
                  <td class="size-px whitespace-nowrap align-top">
                    <a class="block p-6" href="#">
