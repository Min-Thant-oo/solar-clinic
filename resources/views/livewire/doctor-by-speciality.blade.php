                    ...
                    <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        <!-- Doctors -->
                            <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                                ...
                                <h2 class="text-2xl font-bold md:text-4xl md:leading-tight">Our {{ $speciality->speciality_name}} Doctors</h2>
                                    ...
                                    @forelse ($doctors as $doctor)
                                        <div wire:key="{{ $doctor->id }}" class="flex flex-col p-4 bg-white border border-gray-200 rounded-xl md:p-6">
                                            ...
                                            <div class="flex items-center justify-between gap-5 mt-5">
                                                ...
                                                <!-- End Social Brands -->
                                                <a href="{{ auth()->check() ? '' : '/login' }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-lg gap-x-2 hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
                                                    Book Appointment
                                                </a>
